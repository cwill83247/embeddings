...
df = pd.read_csv('contenttoembed/textcopyandpastedplanning.csv')   # pandadata frame 
print(df)
...
df.to_csv('ccbcplanning_embeddings.csv')


## convert the embeddigns file into DataFrames
df = pd.read_csv('ccbcplanning_embeddings.csv')
